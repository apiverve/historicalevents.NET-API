...
namespace APIVerve
{
    public class HistoricalEventsAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/historicalevents";
        ...
        public HistoricalEventsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public HistoricalEventsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, historicaleventsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(historicaleventsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(historicaleventsQueryOptions options)
        {
